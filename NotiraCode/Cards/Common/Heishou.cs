...
public class Heishou() : NotiraCard(1,
    CardType.Power, CardRarity.Uncommon,
    TargetType.Self)
{

    protected override IEnumerable<DynamicVar> CanonicalVars => [new DynamicVar("Kichiku", 6m)];
   ...
   HoverTipFactory.FromPower<KichikuPower>()
    ...
    {
        DynamicVars["Kichiku"].UpgradeValueBy(2m);
    }
}